...
import beans.client;
import beans.livre;
@WebService(name = "demandes")
public class demandes {
//============================ afficher tous les livres ===================== verifié
@WebMethod(operationName = "afficheAll")
...
@WebMethod(operationName = "getRec")
	public livre[] getRec(@WebParam(name = "M")String M){
...
@WebMethod(operationName = "selectLivreId")
	public livre selectLivreId(@WebParam(name = "id")int id){
		dbInteraction.connect();
...
@WebMethod(operationName = "ajouterLivre")
	public int ajouterLivre(@WebParam(name = "l")livre l) {
		dbInteraction.connect();
	...
	//============================ Edit livre ===================================== verifié
@WebMethod(operationName = "editLivre")
	public int editLivre(@WebParam(name = "l")livre l) {
		dbInteraction.connect();
...
@WebMethod(operationName = "supprimerLivre")
	public void supprimerLivre(@WebParam(name = "id")int id) {
		dbInteraction.connect();
...
@WebMethod(operationName = "recClient")
	public client recClient(@WebParam(name = "email")String email,@WebParam(name = "password")String password){
		dbInteraction.connect();
...
@WebMethod(operationName = "verifEmail")
	public int verifEmail(@WebParam(name = "Email")String Email) {
		dbInteraction.connect();
...
@WebMethod(operationName = "verifCB")
	public boolean verifCB(@WebParam(name = "cb")int cb) {
		dbInteraction.connect();
...
@WebMethod(operationName = "ClientNewCompte")
	public boolean ClientNewCompte(@WebParam(name = "c")client c) {
		dbInteraction.connect();
...
//=================================== Ajouter panier ====================================
@WebMethod(operationName = "ajouterP")
	public int ajouterP(@WebParam(name = "idc")int idc,@WebParam(name = "idl")int idl,@WebParam(name = "qte")int qte) {
		dbInteraction.connect();
...
//------------------------------------------------------------------
@WebMethod(operationName = "selectDernierPanier")
...
@WebMethod(operationName = "selectLivreC")
public Panier[] selectLivreC(@WebParam(name = "idc")int idc){
	dbInteraction.connect();
